...
//Get Principal URL
$principal_request="<A:propfind xmlns:A='DAV:'><A:prop><A:current-user-principal/></A:prop></A:propfind>";
...
//Get Calendars
$calendars_request="<A:propfind xmlns:A='DAV:'><A:prop><A:displayname/></A:prop></A:propfind>";
...
echo "<tr><td style='color:darkgreen;'>".$calendar["name"]."</td><td>".$calendar["href"]."</td><td>".$_POST['server'].$calendar["href"]."</td></tr>";
echo "</table><br>";
}
else
{
		...
		<div id="copy">
			<div>
				Version v1.4.1 ; Script copyright &copy; 2011-2016 by <a href='http://www.niftyside.com' target="_blank">NiftySide - Daniel M&uuml;hlbachler</a>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<a href="http://www.icloud.com" target="_blank">iCloud</a> is a service provided by <a href="http://www.apple.com" target="_blank">Apple Inc.</a>
			</div>
		</div>
	</body>
</html>