...
//    public static $HOST_DB    = "000.00.00.00";								// HOST DE LA BASE DE DATOS
	...
	public static $nombreRemite="GESTIONPOLITICA";          					// REMITENTE CORREO PARA MAILGUN Y PHPMAILER
	public static $correoRemite="admin@gestionpolitica.com";   					// CORREO REMITENTE PARA MAILGUN Y PHPMAILER
	public static $nombreDestino="USUARIO CASINOSOFT";    						// NOMBRE DESTINATARIO CORREO PARA MAILGUN Y PHPMAILER

	public static $hostphpmailer="smtp.gmail.com";      						// HOST PHPMAILER
	public static $puertohpmailer=587;         	 								// PUERTO PHPMAILER Port
	public static $Usernamephpmailer="jnadinh@gmail.com";						// CORREO PHPMAILER Username
    public static $Passwordphpmailer="Maria3003"; 								// PASSWORD PHPMAILER
...
//	public static $urlBase="http://ws.gestionpolitica.com/";                    // URL BASE
    ...
    public static $urlIngreso="https://gestionpolitica.com/login/";   			// URL LOGIN
}
?>
